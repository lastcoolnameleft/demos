...
desc "open https://ms.portal.azure.com/#resource/subscriptions/df8428d4-bc25-4601-b458-1c8533ceec0b/resourceGroups/$RESOURCE_GROUP/overview"
...
desc "open http://github.com/kubernetes/charts/tree/master/stable"
